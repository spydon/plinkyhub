...
mixin _$SavedPattern {
 ...
 String get id; String get userId; String get name; String get filePath; DateTime get createdAt; DateTime get updatedAt; String get slug; String get description; bool get isPublic;@JsonKey(readValue: _readUsername) String get username;@JsonKey(readValue: _readStarCount) int get starCount; bool get isStarred; String? get contentHash;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,name,filePath,createdAt,updatedAt,slug,description,isPublic,username,starCount,isStarred,contentHash);

@override
String toString() {
  return 'SavedPattern(id: $id, userId: $userId, name: $name, filePath: $filePath, createdAt: $createdAt, updatedAt: $updatedAt, slug: $slug, description: $description, isPublic: $isPublic, username: $username, starCount: $starCount, isStarred: $isStarred, contentHash: $contentHash)';
}
...
@useResult
$Res call({
 String id, String userId, String name, String filePath, DateTime createdAt, DateTime updatedAt, String slug, String description, bool isPublic,@JsonKey(readValue: _readUsername) String username,@JsonKey(readValue: _readStarCount) int starCount, bool isStarred, String? contentHash
});
...
/// Create a copy of SavedPattern
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? filePath = null,Object? createdAt = null,Object? updatedAt = null,Object? slug = null,Object? description = null,Object? isPublic = null,Object? username = null,Object? starCount = null,Object? isStarred = null,Object? contentHash = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  String filePath,  DateTime createdAt,  DateTime updatedAt,  String slug,  String description,  bool isPublic, @JsonKey(readValue: _readUsername)  String username, @JsonKey(readValue: _readStarCount)  int starCount,  bool isStarred,  String? contentHash)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SavedPattern() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.filePath,_that.createdAt,_that.updatedAt,_that.slug,_that.description,_that.isPublic,_that.username,_that.starCount,_that.isStarred,_that.contentHash);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String name,  String filePath,  DateTime createdAt,  DateTime updatedAt,  String slug,  String description,  bool isPublic, @JsonKey(readValue: _readUsername)  String username, @JsonKey(readValue: _readStarCount)  int starCount,  bool isStarred,  String? contentHash)  $default,) {final _that = this;
switch (_that) {
case _SavedPattern():
return $default(_that.id,_that.userId,_that.name,_that.filePath,_that.createdAt,_that.updatedAt,_that.slug,_that.description,_that.isPublic,_that.username,_that.starCount,_that.isStarred,_that.contentHash);case _:
  throw StateError('Unexpected subclass');
...
class _SavedPattern implements SavedPattern {
  const _SavedPattern({required this.id, required this.userId, required this.name, required this.filePath, required this.createdAt, required this.updatedAt, this.slug = '', this.description = '', this.isPublic = false, @JsonKey(readValue: _readUsername) this.username = '', @JsonKey(readValue: _readStarCount) this.starCount = 0, this.isStarred = false, this.contentHash});
